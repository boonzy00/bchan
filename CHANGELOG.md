...
### Benchmarks
- Establish canonical, fully reproducible performance numbers under locked-governor and core-isolated conditions
  - MPSC (16 producers, batched): 968 M msg/s (mean of 5 runs)
  - SPSC (batched, zero-copy, batch=64): 150 M msg/s (mean of 7 runs, σ ≈ 10 M msg/s)
- Add one-click reproducibility scripts `scripts/run_peak_locked.sh` and `scripts/run_scaling_locked.sh`
- All published figures now backed by governor-locked, cset-isolated measurements on AMD Ryzen 7 5700G
...
### Added
- Establish canonical 206 M msg/s batched SPSC and 968 M msg/s MPSC benchmarks under fully locked conditions
- Add reproducible measurement scripts (`scripts/run_peak_locked.sh`, `scripts/run_scaling_locked.sh`)
